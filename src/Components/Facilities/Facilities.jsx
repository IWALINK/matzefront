      ...
      <section className="Container py-[120px] md:py-0 md:pb-[120px] lg:py-[120px]">
        ...
        >
          <div className=" md:w-[450px] font-Garamond">
            <h5 className="text-base text-khaki leading-[26px] font-medium mb-[14px] uppercase ">
              Notre cuisine
            </h5>
            <h1 className="text-[22px] sm:text-2xl md:text-3xl 2xl:text-[38px] leading-[38px] lg:leading-[44px]  text-lightBlack dark:text-white font-semibold uppercase ">
              Des plats typiquement suisses et italiens au cœur du quartier genevois de Cornavin
            </h1>
          </div>
          <div className="mt-5 md:mt-0">
            <a href="#carte">
              <button className="btn-items">Voir notre carte</button>
            </a>
          </div>
        </div>
        ...
        <div className="">
          ...
          >
            ...
            <div className="relative font-Garamond md:ml-[60px] lg:ml-[107px] mt-3 md:mt-0  h-full">
              ...
              <h1 className="text-2xl md:text-3xl 2xl:text-[32px] leading-[26px] font-semibold text-lightBlack dark:text-white">
                <Link to="/service_details">Cuisine suisse-italienne </Link>
              </h1>
              ...
              <p className="font-Lora text-sm sm:text-base text-gray dark:text-lightGray leading-[26px] font-normal my-10 lg:mt-[46px] lg:mb-[40px] before:absolute before:h-[30px] before:left-0 before:top-[-35px] before:bg-[#ddd] before:w-[1px] relative">
                Une sympathique ambiance montagnarde, une cuisine suisse-italienne des plus goûteuses et une charbonnade croustillante...
              </p>
              <p className="font-Lora text-sm sm:text-base text-gray dark:text-lightGray leading-[26px] font-normal my-10 lg:mt-[46px] lg:mb-[40px] before:absolute before:h-[30px] before:left-0 before:top-[-35px] before:bg-[#ddd] before:w-[1px] relative">
                Notre équipe vous accueille chaleureusement et vous fait découvrir de succulents plats de tradition au rythme des saisons.
              </p>
          ...
          >
            <div className=" font-Garamond md:mr-[2px] lg:mr-[110px]  h-full">
              ...
              <h1 className="text-2xl md:text-3xl 2xl:text-[32px] leading-[26px] font-semibold text-lightBlack dark:text-white">
                <Link to="/service_details">Charbonnade, fondue, ...</Link>
              </h1>
              ...
              <p className="font-Lora relative text-sm sm:text-base text-gray dark:text-lightGray leading-[26px] font-normal my-10 lg:mt-[46px] lg:mb-[40px] before:absolute before:h-[30px] before:left-0 before:top-[-35px] before:bg-[#ddd] before:w-[1px]">
                C’est une cuisine suisse-italienne de marché des quatre saisons que vous propose le chef.
                La carte offre un choix varié et intéressant de mets, à commencer par les spécialités de la maison comme la charbonnade, les fondues, le filet de perche ou encore la sublime entrecôte Matze !
              </p>
              <p className="font-Lora relative text-sm sm:text-base text-gray dark:text-lightGray leading-[26px] font-normal my-10 lg:mt-[46px] lg:mb-[40px] before:absolute before:h-[30px] before:left-0 before:top-[-35px] before:bg-[#ddd] before:w-[1px]">
                Nous proposons également une large variété de pizzas et de
                pâtes.
              </p>
              {/* <Link to="/service_details">
                <HiArrowLongRight
            ...
            <div className="w-full  md:pl-[30px] relative mt-5 md:mt-0">
              <img
                src="/images/home-1/cuisine_2.png"
                alt=""
                className="w-full h-full rounded-lg"
              />
