      ...
      >
        ...
        <SwiperSlide>
          ...
          >
            ...
            <div className="absolute inset-0 bg-[#F5F5DC] bg-opacity-40"></div>
            {/* Contenu */}
            <div className="relative z-10 grid items-center justify-center text-white h-full">
              <div className="font-Garamond 2xl:w-[720px] text-center ">
                <h4 className="text-xl mb-4">José Noeme vous reçoit dans un cadre typiquement suisse au style montagnard, aux couleurs de l'Italie</h4>
                <div className="mb-7 md:mb-8 lg:mb-9 xl:mb-10">
                  <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl 3xl:text-6xl font-semibold leading-[40px] md:leading-[50px] 3xl:leading-[70px] uppercase ">
                    Restaurant La Matze à Genève:
                  </h1>
                  <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl 3xl:text-6xl font-semibold leading-[40px] lg:leading-[50px] 2xl:leading-[60px] uppercase">
              ...
              {/* contact info */}
              <div className="w-[221px] h-[50px] border-white border hidden md:flex items-center justify-center absolute left-0 top-1/2 -rotate-90  bg-khaki">
                <BiPhoneCall className="w-5 h-5 mr-2 text-white" />  022 732 79 61
              </div>
            </div>
          </div>
        </SwiperSlide>
